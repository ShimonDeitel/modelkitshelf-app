...
struct ContentView: View {
    ...
    @State private var editingItem: Kit?
        ...
        NavigationStack {
            ZStack {
                ...
                List {
                    ...
                    Text(item.scale).font(Theme.bodyFont).foregroundColor(Theme.textMuted)
            ...
            .navigationTitle("Model Kit Shelf")
            .toolbar {
            ...
            .sheet(isPresented: $showAdd) {
                AddKitView(isPresented: $showAdd)
                    .environmentObject(store)
            }
            .sheet(item: $editingItem) { existing in
                AddKitView(isPresented: Binding(get: { editingItem != nil }, set: { if !$0 { editingItem = nil } }), editing: existing)
                    .environmentObject(store)
            }
...
struct AddKitView: View {
    ...
    @State private var draft: Kit = Kit(name: "", scale: "", status: "", notes: "")
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    TextField("Scale", text: $draft.scale)
            ...
            .navigationTitle(editing == nil ? "Add Kit" : "Edit Kit")
            .toolbar {
